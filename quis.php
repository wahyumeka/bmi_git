	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" action= "index.php">
				...
				?>
					<textarea class="input100" name="message" placeholder="Hasil BMI ...."><?php  echo "Jumlah BMI Anda adalah   $bmi  " ; ?></textarea>
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input" data-validate = "Message is required">
					<span class="label-input100">KRITERIA</span>
					
					<textarea class="input100" name="message" placeholder="Hasil BMI ...."><?php  echo "$output"; ?></textarea>
					<span class="focus-input100"></span>
				</div>
